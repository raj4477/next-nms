    ...
    <div class="p-4 sm:ml-64">
      <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        <form action="#" method="post" id="noticeForm">
          ...
          <select value={department} onChange={handleSelectButton} required>
          ...
          <div className={style.p}>
            ...
            <div className={style.c2}>
              ...
              <input style={{
                "margin-bottom": "15px",
                "margin-right": "4px"
              }} type='radio' id='admin' value='admin' checked={true} disabled={true} />
          ...
          <input value={heading} className={style.note} type="text" id="subject" name="subject" onChange={(e) => { setHeading(e.target.value) }} required /><br /><br />

          <label for="message">Notice:</label><br />
          <textarea value={note} onChange={(e) => { setNote(e.target.value) }} className={style.note} id="message" name="message" rows="4" cols="50" required></textarea><br /><br />
          ...
          <input onClick={publishNotice} type="button" value="Submit" className={style.inputButton} />
        </form>
